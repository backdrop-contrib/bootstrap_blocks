...
">
  <div class="section-content">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12 col-lg-6 col-xl-4 pr-0 pr-md-5 mb-3"><?php echo $first_section; ?></div>
        <div class="col-12 col-lg-6 col-xl-4 pr-0 pr-md-5 mb-3"><?php echo $second_section; ?></div>
        <div class="col-12 col-lg-6 col-xl-4 pr-0 pr-md-5"><?php echo $third_section; ?></div>
      </div>
    </div>
  </div>
</div>